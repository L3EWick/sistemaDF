...
<html lang="pt-br">
	...
	<body>
		...
		@yield('conteudo')  
		{{-- <button type="button" class="print_confirma btn btn-success btn-app"> --}}
		<button type="button" class="print btn btn-success" id="btn_print">
	...
	<script type="text/javascript">
		...
		$('#btn_print').on('click', function() {
			...
			//console.log(JSON.stringify("{{$pjud}}"));
			$.post("{{ url('/pjud/peticiona/registra_peticao') }}", {
				_token  : "{{ csrf_token() }}",
				pjud:	"{{$pjud}}",
			},function(resultado){
